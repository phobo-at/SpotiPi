...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    'de': {
        ...
        'playback_error': 'Wiedergabe-Fehler',
        ...
        # Settings Page
        'settings_tab': '<svg class="icon"><use href="/static/icons/icons.svg#cog"></use></svg><span>Einstellungen</span>',
        'settings_label': 'Einstellungen',
        'settings_title': 'Einstellungen',
        'spotify_account': 'Spotify-Konto',
        'loading_account': 'Lade Konto-Informationen...',
        'connected_account': 'Verbundenes Konto',
        'feature_flags': 'Funktionen',
        'feature_sleep_label': 'Sleep-Timer',
        'feature_sleep_desc': 'Sleep-Timer Funktion einblenden (wird nicht mehr benötigt, da Spotify diese Funktion jetzt nativ unterstützt)',
        'feature_library_label': 'Musik-Bibliothek',
        'feature_library_desc': 'Musik-Bibliothek Tab anzeigen',
        'app_settings': 'App-Einstellungen',
        'language_label': 'Sprache',
        'language_desc': 'Sprache der Benutzeroberfläche',
        'default_volume_label': 'Standard-Lautstärke',
        'default_volume_desc': 'Standard-Lautstärke für den Wecker',
        'debug_label': 'Debug-Modus',
        'debug_desc': 'Erweiterte Log-Ausgaben aktivieren',
        'advanced_settings': 'Erweitert',
        'clear_cache_label': 'Cache leeren',
        'clear_cache_desc': 'Alle zwischengespeicherten Daten löschen',
        'clear_cache_btn': 'Cache leeren',
        'version_label': 'Version',
        'danger_zone': 'Gefahrenbereich',
        'disconnect_spotify_label': 'Spotify trennen',
        'disconnect_spotify_desc': 'Verbindung zu Spotify aufheben (erfordert Neuanmeldung)',
        ...
        'spotify_profile_error': 'Spotify-Profil konnte nicht geladen werden',
    ...
    'en': {
        ...
        # Settings Page
        'settings_tab': '<svg class="icon"><use href="/static/icons/icons.svg#cog"></use></svg><span>Settings</span>',
        ...
        'feature_sleep_label': 'Sleep Timer',
        'feature_sleep_desc': 'Show Sleep Timer feature (no longer needed as Spotify now supports this natively)',
        'feature_library_label': 'Music Library',
        'feature_library_desc': 'Show Music Library tab',
        'app_settings': 'App Settings',
        'language_label': 'Language',
        'language_desc': 'User interface language',
        'default_volume_label': 'Default Volume',
        'default_volume_desc': 'Default volume for the alarm',
        'debug_label': 'Debug Mode',
        'debug_desc': 'Enable extended log output',
        'advanced_settings': 'Advanced',
        'clear_cache_label': 'Clear Cache',
        'clear_cache_desc': 'Delete all cached data',
        'clear_cache_btn': 'Clear Cache',
        'version_label': 'Version',
        'danger_zone': 'Danger Zone',
        'disconnect_spotify_label': 'Disconnect Spotify',
        'disconnect_spotify_desc': 'Disconnect from Spotify (requires re-authentication)',
        'disconnect_btn': 'Disconnect',
        'no_changes': 'No changes to save',
        'settings_save_error': 'Failed to save settings',
        'spotify_profile_error': 'Failed to load Spotify profile',

...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    'de': {
        ...
        'single_alarm_mode_hint': 'Dieser Wecker klingelt einmalig. Wiederkehrende Tage werden später konfigurierbar.',
    ...
    'en': {
        ...
        'single_alarm_mode_hint': 'This alarm triggers once. Recurring schedules will be configurable later.',
